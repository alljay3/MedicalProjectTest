...
public class DiseaseRepository
{
    ...
    public async Task<Disease> Get(Guid id)
    {
        ...
        return new Disease(diseaseEntity.Id, diseaseEntity.Name, PatientMapper.Create(diseaseEntity.CurrentPatient), DoctorMapper.Create(diseaseEntity.AttendingDoctor), diseaseEntity.Symptoms,
